...
import com.framgia.moviedb_20.screen.main.home.adapter.NowPlayingAdapter;
import com.framgia.moviedb_20.screen.main.home.adapter.OnItemClickListener;
import com.framgia.moviedb_20.screen.main.home.adapter.PopularAdapter;
import com.framgia.moviedb_20.screen.main.home.adapter.TopRatedAdapter;
import com.framgia.moviedb_20.screen.main.home.adapter.UpComingAdapter;
...
public class HomeFragment extends Fragment implements HomeContract.View, BaseGetDataAsyncTask.OnGetDataListener<Category>, OnItemClickListener {
    ...
    public void showUpComing() {
        mUpComingAdapter = new UpComingAdapter(mCategories.get(0).getBaseMovie());
        mRecyclerViewUpComing.setAdapter(mUpComingAdapter);
        mUpComingAdapter.onItemClickListener(this);
    }

    @Override
    public void showPopular() {
        mPopularAdapter = new PopularAdapter(mCategories.get(0).getBaseMovie());
        mRecyclerViewPopular.setAdapter(mPopularAdapter);
        mPopularAdapter.onItemClickListener(this);
    }

    @Override
    public void showNowPlaying() {
        mNowPlayingAdapter = new NowPlayingAdapter(mCategories.get(0).getBaseMovie());
        mRecyclerViewNowPlaying.setAdapter(mNowPlayingAdapter);
        mNowPlayingAdapter.onItemClickListener(this);
    }

    @Override
    public void showTopRated() {
        mTopRatedAdapter = new TopRatedAdapter(mCategories.get(0).getBaseMovie());
        mRecyclerViewTopRated.setAdapter(mTopRatedAdapter);
        mTopRatedAdapter.onItemClickListener(this);
    }
